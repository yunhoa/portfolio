...
export const projects = [
  ...
  },
  {
    ...
    summary:
      '스마트플랜트 제조현장의 3D 가상환경 구축을 돕기 위해, 설비 이미지에서 객체 이미지와 메타정보를 생성하는 모바일-서버 연동형 처리 흐름을 구현한 프로젝트입니다.',
    highlights: [
    ...
    background:
      '플랜트 산업 가상 자율제조를 위한 LoD4 수준 온디바이스 AI 기반 제조현장 3차원 모델 자동제작 기술개발 및 실증 과제에서 진행한 R&D 프로젝트입니다.',
    role: [
    ...
    problem:
      '기존 플랜트 가상환경 구축은 도면 수집, 3D 스캐닝, 전문가 수작업에 의존해 초기 구축 비용과 시간이 컸습니다. 실제 현장 이미지는 설비, 구조물, 배관이 함께 있어 관심 설비만 분리하기 어렵고, 처리 결과를 수정하거나 되돌리는 흐름도 필요했습니다.',
    solution:
