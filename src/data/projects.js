...
export const projects = [
  ...
  },
  {
    ...
    description:
      '사용자 취향과 현재 위치를 기준으로 서울 데이트 장소를 추천하고, 지도에서 이동 경로를 확인할 수 있게 만든 캡스톤 프로젝트입니다.',
    background:
    ...
    problem:
      '제공받은 관광 데이터는 바로 지도 API에 넣기 어려운 구조였습니다. 장소명과 좌표를 뽑아야 했고, TMAP API와 대중교통 API가 요구하는 형식에 맞게 다시 가공해야 했습니다.',
    solution:
      'JavaScript 모듈을 만들어 JSON 데이터에서 필요한 값만 추출했습니다. 추출한 데이터를 API 요청 형식에 맞게 바꾸고, 장소 간 경로와 예상 이동 시간을 지도 화면에 표시했습니다.',
    outcomes: [
    ...
    tech: ['JavaScript', 'REST API', 'TMAP API', 'Public Data API', 'JSON', 'Responsive Web', 'UI/UX'],
  },
];
